...
$('.account__head-arrowLeft').on('click', function () {
    $('.account__head').addClass('right').removeClass('left');
})

$('.account__head-arrowRight').on('click', function () {
    $('.account__head').addClass('left').removeClass('right');
})